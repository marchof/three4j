...
public class PlainMessageImageTest {

	@Test
	public void toString_should_return_blobid() {
		...
		var msg = new PlainMessage.Image(blob);
		assertEquals("Image[11112222333344445555666677778888]", msg.toString());
	}
